...
const jobsData: Job[] = [
  {
    ...
    description: [
      'Continue work done during contract period, focusing on building performant, user-friendly web applications.',
      'Lead effort among variety of teams to update and deploy JTT Core',
    ],
    skills: ['Javascript', 'React', 'Docker', 'Cesium', 'CI/CD', 'Java', 'Spring', 'Kubernetes'],
    location: { city: 'Suffolk', state: 'VA', coordinates: [-76.5836, 36.7282] },
  },
  {
    id: 'insight-global-2024',
    company: 'Insight Global (Contracted to Huntington Ingalls Industries)',
    title: 'Software Engineer Consultant',
    period: 'Sep 2024 - Jun 2025',
    descriptionText: 'Contracted to HII on the same project prior to full-time conversion.',
    description: [
      'Developed cutting-edge React based web application to satisfy customer requirements.',
      'Assisted in deployment and testing of project from development to production environment.',
      'Optimized JTT map to allow for significantly increased entity count without sacrificing quality.',
    ],
    skills: ['Javascript', 'React', 'Docker', 'Cesium', 'CI/CD'],
    location: { city: 'Suffolk', state: 'VA', coordinates: [-76.5836, 36.7282] },
  },
  {
    id: 'nsa-2024',
